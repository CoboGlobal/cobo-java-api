...
public interface CoboMPCApiRestClient {
    ...
    ApiResponse<MPCTransactions> getTransactionByRequestIds(String requestIds, Integer status);
    ApiResponse<MPCTransactions> getTransactionByCoboIds(String coboIds, Integer status);
    ApiResponse<MPCTransactions> getTransactionByTxHash(String txId, Integer transactionType);
