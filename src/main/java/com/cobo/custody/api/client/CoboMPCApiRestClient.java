...
public interface CoboMPCApiRestClient {
    ...
    ApiResponse<MPCPostTransactions> createTransaction(String coin, String requestId, String fromAddr, String toAddr, BigInteger amount,
    ...
    ApiResponse<MPCPostTransactions> dropTransaction(String coboId, BigInteger gasPrice, BigInteger gasLimit);
