...
public class CoboApiRestClientImplTest extends TestCase {
    ...
    public void testGetTransaction() {
        ApiResponse<Transaction> res = client.getTransaction("20210422193807000343569000002370");
        assertTrue(res.isSuccess());
    }

    public void testGetTransactionsById() {
        ApiResponse<List<Transaction>> res = client.getTransactionsById(null, Side.Any, null, null, null, 50, null);
        assertTrue(res.isSuccess());
        System.out.println(res.getResult().size());
    }

    public void testGetTransactionsByTime() {
        ApiResponse<List<Transaction>> res = client.getTransactionsByTime(null, Side.Any, null, 0, 0, 50, null);
        assertTrue(res.isSuccess());
